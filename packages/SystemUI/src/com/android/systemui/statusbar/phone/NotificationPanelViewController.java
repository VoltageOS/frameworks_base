...
import com.android.systemui.VoltageSystemUIUtils;
...
public class NotificationPanelViewController extends PanelViewController {
    ...
    public void reTickerView(boolean visibility) {
        if (!VoltageSystemUIUtils.settingStatusBoolean("reticker_status", mView.getContext())) return;
        ...
        if (visibility && getExpandedFraction() != 1) {
            ...
            if (VoltageSystemUIUtils.settingStatusBoolean("reticker_colored", mView.getContext())) {
                int col;
    ...
    private void reTickerViewVisibility() {
        if (!VoltageSystemUIUtils.settingStatusBoolean("reticker_status", mView.getContext())) {
            reTickerDismissal();
            return;
        }
