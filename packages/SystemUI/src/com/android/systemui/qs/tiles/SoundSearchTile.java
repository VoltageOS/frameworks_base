...
public class SoundSearchTile extends QSTileImpl<BooleanState> {
    ...
    public void handleClick(@Nullable View view) {
        ...
        // Shazam
        if (VoltageUtils.isPackageInstalled(mContext, "com.shazam.android")
                    || VoltageUtils.isPackageInstalled(mContext, "com.shazam.encore.android")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
            intent.setAction("com.shazam.android.intent.actions.START_TAGGING");
            mContext.startActivity(intent);
        // Soundhound
        } else if (VoltageUtils.isPackageInstalled(mContext, "com.melodis.midomiMusicIdentifier.freemium")
                    || VoltageUtils.isPackageInstalled(mContext, "com.melodis.midomiMusicIdentifier")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
