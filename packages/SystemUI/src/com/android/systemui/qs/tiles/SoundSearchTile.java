...
public class SoundSearchTile extends QSTileImpl<BooleanState> {
    ...
    protected void handleClick(@Nullable View view) {
        ...
        // Soundhound
        if (VoltageUtils.isPackageInstalled(mContext, "com.melodis.midomiMusicIdentifier.freemium") || VoltageUtils.isPackageInstalled(mContext, "com.melodis.midomiMusicIdentifier")) {
